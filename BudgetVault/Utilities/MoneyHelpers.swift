...
enum MoneyHelpers {
    ...
    static func centsToDollars(_ cents: Int64) -> Decimal {
        Decimal(cents) / 100
    }

    /// Convert Decimal dollars to Int64 cents: 14.50 → 1450
    static func dollarsToCents(_ dollars: Decimal) -> Int64 {
    ...
    static func parseCurrencyString(_ string: String) -> Int64? {
